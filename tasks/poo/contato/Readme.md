e# Gerenciando telefones de um único contato
...
![cover](../../.tko/cache/poo/base/contato/cover.jpg)
...
![diagrama](../../.tko/cache/poo/base/contato/diagrama.png)

[![youtube icon](../../.tko/cache/poo/base/contato/../youguide.png)](https://youtu.be/jqNToRuOQhg?si=xn0CV6dPfEp11KG0)


<!-- links .cache/draft -->
- cpp
  - [shell.cpp](../../.tko/cache/poo/base/contato/.cache/draft/cpp/shell.cpp)
- java
  - [Shell.java](../../.tko/cache/poo/base/contato/.cache/draft/java/Shell.java)
- ts
  - [shell.ts](../../.tko/cache/poo/base/contato/.cache/draft/ts/shell.ts)
<!-- links -->
